...
const ProyectosProvider = ({ children }) => {
  ...
  const [proyecto, setProyecto] = useState({}); // Proyectos que se mostraran en la pagina de proyecto.
  const [cargando, setCargando] = useState(false); // Spinner de carga.
  const [modalFormularioTarea, setModalFormularioTarea] = useState(false); //para los modales.
